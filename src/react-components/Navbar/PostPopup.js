  ...
  render() {
    return (
      <Popup {...this.props} style="post-popup">
        <header className="post-header">Post a new recipe</header>
        <section>
         <table>
          <tbody>
           <tr>
            <td>Name</td>
            <td><input placeholder="Enter recipe's name" ref="name"/></td>
           </tr>
           <tr>
            <td>Description</td>
            <td><input placeholder="Enter recipe's description" ref="description"/></td>
        </tr><tr>
          <td>Link</td>
